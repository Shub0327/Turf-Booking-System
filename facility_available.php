...
<!-- Mirrored from technext.github.io/montana/rooms.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Sep 2022 04:10:35 GMT -->
                            ...
                            <div class="main-menu  d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">
                                        ...
                                        <li><a class="active"  href="http://localhost/scbs/facility_available.php">Facilities</a></li>
                                        <li><a href="http://localhost/scbs/about.html">About Us</a></li>
                                        <li><a href="#">Login <i class="ti-angle-down"></i></a>
                                            <ul class="submenu">
                                                <li><a href="http://localhost/scbs/login.php">Login</a></li>
                                                <li><a href="http://localhost/scbs/register.php">Register</a></li>
                                                 <li><a href="http://localhost/scbs/admin/login.php">Admin</a></li>
                                            </ul>
                                        </li>
